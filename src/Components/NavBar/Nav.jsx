...
const Nav = () => {
    ...
    return (
        <div className={`px-4 lg:px-20 ${darkTheme ? "bg-black text-white" : "bg-white text-black"}`}>
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-2xl font-bold">Movie World</a>
                </div>
                ...
                <div className="navbar-end">
                    ...
                    <button onClick={toggleTheme} className="flex items-center ml-3 space-x-2">
                        {darkTheme ? (
                            <FaSun className="text-yellow-400 text-xl" title="Switch to Light Mode" />
                        ) : (
                            <FaMoon className="text-blue-500 text-xl" title="Switch to Dark Mode" />
                        )}
                    </button>
