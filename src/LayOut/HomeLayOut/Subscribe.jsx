    ...
    return (
        <div className="w-full max-w-2xl text-center space-y-6 mx-auto py-8">
            <div className="flex items-center justify-center space-x-4">
                ...
                <h1 className={`text-4xl font-bold ${darkTheme? "text-white":"text-gray-800"}  tracking-wide`}>NEWSLETTER</h1>
                <div className="flex-grow border-t-2 border-blue-500"></div>
            </div>
            <p className={`${darkTheme? "text-white":"text-gray-600"} italic`}>Subscribe to our newsletter.</p>
