...
const FeaturedMovie = ({ movie }) => {
    ...
    return (
        <div className='mb-10'>
            <div className={`max-w-sm bg-white shadow-lg rounded-lg overflow-hidden flex flex-col h-full ${darkTheme && "border"}`}>
                <img
                    className="w-full h-64 object-cover"
                    src={poster}
                    alt={title}
                />
                <div className={`p-5 flex flex-col flex-grow ${darkTheme ? "bg-black text-white" : "bg-white text-black"}`}>
                    ...
                    <p className={`text-sm  line-clamp-3 mb-4 flex-grow ${darkTheme ? "text-white" : " text-gray-700"}`}>
